...
public class StoreEditView extends JFrame implements ActionListener {
	...
	public StoreEditView() {
		...
		btnNewButton_1.setIcon(new ImageIcon("gui_imgs/btn_menuEdit_3.png"));
		btnNewButton_1.setBounds(650, 400, 107, 51);
		...
		textField_4.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		...
		comboBox.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		comboBox.setForeground(Color.BLACK);
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"업종을 선택하세요.", "한식", "중식", "일식", "분식"}));
		comboBox.setBounds(187, 296, 197, 34);
		panel_1.add(comboBox);

		textField_2 = new JTextField();
		textField_2.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		textField_2.setColumns(10);
		textField_2.setBounds(186, 355, 198, 28);
		panel_1.add(textField_2);
		
		textField_5 = new JTextField();
		textField_5.setFont(new Font("맑은 고딕", Font.BOLD, 14));
