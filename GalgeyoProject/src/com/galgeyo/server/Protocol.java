...
public interface Protocol {
	...
	public static final byte FIND_ID = 6;  //ID/PW찾기 ::: 이름, 전화번호 입력 후 ID[검색] 눌렀을 때
	public static final byte FIND_PW = 7;  //ID/PW찾기 ::: 아이디, 전화번호 입력 후 PW[검색] 눌렀을 때
	public static final byte MODIFY_PASSWORD=8; //비밀번호 변경
	...
	public static final byte ACCEPT_CANCEL = 11;  //매장관리자 메인 ::: 응답대기자 리스트에서 주문자 체크 후 [주문거절] 눌렀을 때
